object Versions {
    ...
    const val firebaseConfig    = "16.5.0"
...
object Android {
    const val applicationId = "com.bt.car"
...
object ProductFlavor {
    const val qa                = "qa"
    const val applicationIdQa   = "${Android.applicationId}.qa"
    ...
    const val applicationIdDevelop  = "${Android.applicationId}.dev"
    ...
    const val applicationIdStaging  = "${Android.applicationId}.stg"
    ...
    const val applicationIdProduction   = Android.applicationId
